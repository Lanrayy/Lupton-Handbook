...
def get_pages(key):
    switcher = {
        #main menu  | sub menu
        "quick_info" : [["rla_info","security","lsmp"],
                        ["RLA Info","Security", "LSMP"], "Quick Info"],
        ...
        "student_welfare": [["welfare_check", "missing_student", "mental_health", "suicide_attempt", "harrassment_and_bullying"],
                            ...
                            "Student Welfare"],
        "sexual_violence" : [["sexual_violence_questions","historic_disclosure","recent_disclosure", "sexual_violence_documentation"],
                            ["Sexaul Violence Questions","Historic Disclosure", "Recent Disclosure", "Sexual Violence Documentation"],
                            "Sexual Violence"],
        "flat_issues": [["flatmate_conflict", "physical_altercation", "food_theft", "tidyness", "theft"],
                            ["Flatmate Conclift", "Physical Altercation", "Food Theft", "Tidyness", "Theft"],
                            "Flat Issues"],
...
def get_info(key):
    switcher = {
        # page info
        "rla_info" : ["Quick Info", "RLA duty mobile:  07903 610116. <br> \
                        ...
                        SITE PHONE: <br> 0000- phone password <br> Then 83860 <br> (BEN’s ACCOUNT) <br> "],
        ...
        "lsmp" :["LSMP", "4 Blenheim Court <br> \
                        Blenheim Walk <br>Leeds <br>LS2 9AE <br>0113 295 4488 <br> www.leeds.ac.uk/lsmp/ <br>\
        ...
        "actual_fire" : ["Actual Fire", "When there is an <b> actual fire </b>, the buzzer will go off. \
                        ...
                        to your designated evacuation point. \n You should call the fire brigade immediately, followed\
                        by University\ Security, Private Security (if applicable)and then your Residence Life Warden\
                        to report to incident. Do not attempt to tackle a fire yourself unless you are sure that it is\
                        ...
                        congregate at the designated evacuation point. Once everything has settled and everyone is safe, \
        ...
        "non_immediate_medical_issue" : ["Non-Immediate Medical Issue", "If a student does not need immediate\
                        ...
                        a more serious accident you can speak to the student about calling security or 111. You can also provide\
        ...
        "accident_or_illness" : ["Accidents or Illness", " Contact details for the Leeds Student Medical Practice: <br> 4 Blenheim Court <br> \
        ...
        "historic_disclosure" : ["Disclosure of sexual violence", "1.Respond sensitively to the disclosure by listening, telling \
                        ...
                        speak with the student, provide options and resources to the students. <br> 4. If the student does not need additional \
                        support the RLW on-call should be called and notified after you finish your conversation with the student.<br> 5. You, \
                        ...
                        Team – if yes – this team will reach out and get in touch with the student to provide support. <br>8. Document in \
                        StarRez with the pre-determined disclosure report that notes the date of the disclosure, the name of the RLA, \
                        identifies that a disclosure of historical, was made and whether:a. Support was identified for the student and \
                        no further action was requested to be taken; or b. The RLW on call was contacted <br> 9. The Residence Life Warden \
        ...
        "recent_disclosure" : ["Recent Disclosure", "1.Respond sensitively to the disclosure by: listening, telling the survivor \
                        ...
                        attend, and should call them. a. The Residence Life Warden will speak with the student, provide options \
                        and resources to the students. b. If the student would like to report the incident right away, Security \
                        ...
                        mandatory to make sure the survivor is aware of the Misconduct & Harassment team. Supply referral \
                        ...
                        follow up unless the student requests it <br>11. Document in StarRez with the pre-determined disclosure \
                        report that notes the date of the disclosure, the name of the RLA, identifies that a disclosure \
        ...
        "sexual_violence_questions" : ["Sexual Violence Questions", "Questions to ask to determine support <br>1. Are you currently feeling safe in your Residence?\
        ...
        "parties": ["Parties", "Usually, a named student will be the ‘responsible person’ for the party, and they will be held\
                        ...
                        the party organiser and tell them (politely) that the party needs to be stopped.  If they ignore your\
                        ...
                        Warden(s) know.Document the incident on Starrez"],
        "smooking_in_flats" : ["Smoking in flats", "In accordance with UK legislation, smoking is banned in all open-access communal\
        ...
        "drugs": ["Substance Use Concerns", "Students should be made aware that the use and possession of cannabis is\
                        still illegal, even buying for flat members if considered supplying and offenders may be prosecuted or cautioned, at the discretion of the Police. A caution, by\
                        the way, is never spent, and remains on one’s record, so, if one is offered a caution as an alternative to\
                        prosecution, and accepts it, one is accepting that it will remain on police files and will be disclosed\
                        on Disclosure and Barring checks."],
        "flatmate_conflict" : ["Flatmate conflicts", "If a resident comes to you with concerns about a flatmate, use the active \
                        ...
                        their flatmates about the issues they are experiencing. After speaking with the student, Document the incident on Starrez. \
        ...
        "physical_altercation": ["Physical Altercation", "If you come upon a situation where someone has become physically violent or there is a \
                        ...
                        You should not put yourself between two people and should only attempt to stop violent behaviour through verbal intervention \
                        if you feel comfortable. While you are waiting for security to arrive you can focus on clearing the area of others. The \
                        situation should be documented on StarRez."],
        ...
        "theft":["Theft", "If a student comes to you about a theft, you should direct them to file a report with Security. You should then write an\
                        incident report, so your Warden is aware of this situation in case other actions need to be taken. Document Incident on Starrez"],
